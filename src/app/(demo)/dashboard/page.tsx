...
// Adjust import path for reusable components
import StatCard from "@/components/reuseble_components/StatCard";

// Dashboard component now only renders the dashboard view
export default function Dashboard() {
  // Hardcoded attendance data from original file
